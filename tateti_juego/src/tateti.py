...
class Tateti:
    def __init__(self, jugador1: Jugador, jugador2: Jugador):
        ...
        self.ganador = None
        self.juego_terminado = False  # Nuevo estado
    ...
    def jugar(self, fila: int, col: int) -> bool | None:
        """Devuelve:
        - True: si hay ganador/empate
        - False: turno cambiado
        - None: movimiento inválido
        """
        if self.juego_terminado or self.ganador or self.tablero.empate():
            return True
